 ...
 * are the total-charge ↔ density identities the grader accepts, e.g. Q = λL. */
export type Distribution={id:string;field(p:Params):Vec;quadrature(p:Params,n:number):Vec;sample(p:Params,n:number):ChargeSample[];substitutions?:Record<string,string>};
