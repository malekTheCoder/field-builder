...
export type Limit={id:string;title:string;prompt:string;answer:string;choices:string[];explanation:string;formula:string;mode:'far'|'infinite'|'center'|'half'|'full'|'scale'|'maximum'|'moment'|'near';reference:string};
